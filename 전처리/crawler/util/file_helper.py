...
class FileReader:
    ...
    reviewcol =[
        'shop_id','review_cmnt','taste_rate','quantity_rate','delivery_rate','review_time','review_img','userid','review_id','food_id'
    ]
            ...
            for line in input_data:
                if line['id'] != '' :
                    ...
                    for idx in reviews:
                        ...
                        img = ['review_images']
                        for imgidx in img:
                            imsi = [line['id', comment, idx['rating_taste'], idx['rating_quantity'], idx['rating_delivery'],idx['itme'],img['review_images']['thumb'],idx['nickname'],idx['id'],idx['menu_summary'] ]]
                        result.append(imsi)
