...
class YogiyoCrawler:
    ...
    def get_json_menu(self, start, end, list_data):
        ...
        # 파일 저장
        reader = self.reader
        reader.context = os.path.join(baseurl, 'data/json/menu(seoul)_image')
...
if __name__ == '__main__':
    ...
    yogiyo.get_json_menu(2000, 3000, json_data)
    ...
    # end = 1000
    # for i in range(42):
    #     input_file_path = 'C:/Users/user/Desktop/chatbot/전처리/data/json/review(seoul)/yogiyo_review({start}~{end}).json'
    #     try:
    #         print("오니?")
    ...
    #     start += 1000
    #     end += 1000
    # yogiyo.review_csv(f'/Users/user/Desktop/chatbot/전처리/data/json/review(seoul)/yogiyo_review({0}~{1000}).json', 0, 1000)
